...
from main.views import (books_list, CreateBookView, BookDetailsView, BookUpdateView, BookDeleteView, OrderViewSet)

router = SimpleRouter()
router.register(r'orders', OrderViewSet, basename='orders')

def api_root(request):
    return JsonResponse({"message": "Welcome to the Library API! Use /api/v1/ for requests."})
